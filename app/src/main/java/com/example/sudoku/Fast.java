...
public class Fast extends AppCompatActivity {
    ...
    static long bas = 0;
    public static int countHints = 0;


    Button SolveBut, ClearBut;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Home1.setOnClickListener(view -> {
            Intent openPage = new Intent(Fast.this, MainActivity.class);
        ...
        public void run() {
            ...
            while (true) {
                ...
                if (gameGeneratore.End(base)) {
                    ...
                    Intent openPage = new Intent(Fast.this, WinFast.class);
                    startActivity(openPage);
                    break;
                }
