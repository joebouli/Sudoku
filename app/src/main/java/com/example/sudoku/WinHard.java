...
public class WinHard extends MainActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Home.setOnClickListener(view -> {
            Intent openPage = new Intent(WinHard.this, MainActivity.class);
            startActivity(openPage);
        });

        long bas;
        int countHints = Hard.countHints();
        double score = 0;
        ...
        Button.setOnClickListener(view -> {
            Intent openPage = new Intent(WinHard.this, Pageplay.class);
            startActivity(openPage);
        });
