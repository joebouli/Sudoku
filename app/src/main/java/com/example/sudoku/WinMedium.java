...
public class WinMedium extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Home.setOnClickListener(view -> {
            Intent openPage = new Intent(WinMedium.this, MainActivity.class);
            startActivity(openPage);
        });

        long bas;
        int countHints = Medium.countHints();
        double score = 0;
        ...
        Button.setOnClickListener(view -> {
            Intent openPage = new Intent(WinMedium.this, Pageplay.class);
            startActivity(openPage);
        });
