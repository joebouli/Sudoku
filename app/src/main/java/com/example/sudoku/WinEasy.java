...
public class WinEasy extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Home.setOnClickListener(view -> {
            Intent openPage = new Intent(WinEasy.this, MainActivity.class);
            startActivity(openPage);
        });

        long bas;
        int countHints = Easy.countHints();
        double score = 0;
        ...
        Button.setOnClickListener(view -> {
            Intent openPage = new Intent(WinEasy.this, Pageplay.class);
            startActivity(openPage);
        });
